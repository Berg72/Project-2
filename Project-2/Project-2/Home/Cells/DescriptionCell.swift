...
class DescriptionCell: UITableViewCell {
    ...
    func configure(text: String?, placeHolder: String, tableView: UITableView, textChanged: @escaping TextChanged) {
        ...
        if let text = text {
            ...
            textView.textColor = UIColor.black.withAlphaComponent(0.15)
